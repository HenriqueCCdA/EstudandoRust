...
fn main() {
    ...
    println!("My favoti season is {season}. The team scored {points_scored} points. A touchdown is worth {TOUCHDOWN_POINTS} points.");

    println!("My favoti season is {}. The team scored {} points. A touchdown is worth {} points.", season, points_scored, event_time);
